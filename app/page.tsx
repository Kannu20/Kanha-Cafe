        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="font-body text-sm sm:text-base text-bakery-200 leading-relaxed mb-4">
              Founded in 2008 by the chandlani family, Kanha Bakers began as a small neighborhood bakery with a single oven and an enormous dream — to bring European artisan baking techniques to the people of newai.
            </p>
