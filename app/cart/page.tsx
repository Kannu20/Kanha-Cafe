          ...
          <div className="grid lg:grid-cols-3 gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-6 sticky top-28 mt-4 lg:mt-0">
                ...
                <div className="flex justify-between items-center mb-6 p-3 sm:p-4 bg-bakery-50 rounded-xl sm:rounded-2xl border border-bakery-100">
                  <span className="font-display text-base sm:text-lg font-bold text-mocha">Total</span>
                  <span className="font-display text-xl sm:text-2xl font-bold text-bakery-700">₹{grandTotal}</span>
                </div>

                <Link
                  href="/checkout"
                  className="bakery-btn w-full justify-center text-sm sm:text-base py-3 sm:py-4"
                >
