...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-cream overflow-x-hidden w-full">
      ...
      <section className="bg-gradient-to-br from-mocha to-[#5a2f18] py-20 sm:py-28 px-4 sm:px-6 lg:px-8 pt-28 sm:pt-36 overflow-hidden">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <motion.h1
            ...
            className="font-display text-4xl sm:text-5xl md:text-6xl font-bold text-white leading-[1.2]"
          >
          ...
          <motion.p
            ...
            className="font-body text-sm sm:text-base text-bakery-200 mt-4 max-w-sm sm:max-w-xl mx-auto px-2 sm:px-0"
          >
      ...
      {/* Form + Map */}
      <section className="overflow-hidden w-full pb-16 sm:pb-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12">
          ...
          >
            <h2 className="font-display text-xl sm:text-2xl font-bold text-mocha mb-6">Send us a Message</h2>
            ...
            {submitted ? (
              ...
              <div className="space-y-4">
                <div className="grid sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block font-body text-[11px] sm:text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wider">Full Name *</label>
                    <input
                      name="name"
                      value={form.name}
                      onChange={handleChange}
                      placeholder="Your name"
                      className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-bakery-50 border border-bakery-100 rounded-xl font-body text-sm focus:outline-none focus:border-bakery-400 focus:ring-2 focus:ring-bakery-100 transition-all"
                      required
                    />
                  </div>
                  <div>
                    <label className="block font-body text-[11px] sm:text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wider">Phone</label>
                    <input
                      name="phone"
                      value={form.phone}
                      onChange={handleChange}
                ...
                <div>
                  <label className="block font-body text-[11px] sm:text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wider">Email *</label>
                  <input
                    name="email"
                    type="email"
                    value={form.email}
                ...
                <div>
                  <label className="block font-body text-[11px] sm:text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wider">Subject</label>
                  <select
                    name="subject"
                    value={form.subject}
                    onChange={handleChange}
                ...
                <div>
                  <label className="block font-body text-[11px] sm:text-xs font-semibold text-gray-500 mb-1.5 uppercase tracking-wider">Message *</label>
                  <textarea
                    name="message"
                    value={form.message}
                    onChange={handleChange}
                    ...
                    rows={4}
                    className="w-full px-3 sm:px-4 py-2.5 sm:py-3 bg-bakery-50 border border-bakery-100 rounded-xl font-body text-sm focus:outline-none focus:border-bakery-400 focus:ring-2 focus:ring-bakery-100 transition-all resize-none sm:rows-[5]"
                    required
                  />
                </div>
          ...
          >
            ...
            {/* Quick info card */}
            <div className="bg-mocha rounded-2xl sm:rounded-3xl p-5 sm:p-6 text-white border border-white/10 shadow-lg">
              <h3 className="font-display text-lg sm:text-xl font-bold mb-2 sm:mb-3">Can't come in person?</h3>
              <p className="font-body text-bakery-200 text-xs sm:text-sm leading-relaxed mb-4">
