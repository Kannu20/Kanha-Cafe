...
export const products: Product[] = [
  ...
  // ── MAIN COURSE ──────────────────────────────────────────────
  { id:'mc1',  category:'Main Course', name:'Paneer Lababdar',       price:280, badge:'Popular',    rating:4.7, reviews:128, description:'Rich creamy paneer in a velvety tomato-onion gravy.',                image:'/images/lababdar.jpg' },
  { id:'mc2',  category:'Main Course', name:'Shahi Paneer',          price:280, badge:null,         rating:4.6, reviews:98,  description:'Royal Mughlai paneer curry with cashew-cream sauce.',                image:'/images/shai-paneer.jpg' },
  { id:'mc3',  category:'Main Course', name:'Kadai Paneer',          price:280, badge:null,         rating:4.5, reviews:87,  description:'Paneer cooked in a robust kadai masala with capsicum.',              image:'/images/Kadai-Paneer.jpg' },
  { id:'mc4',  category:'Main Course', name:'Matar Paneer',          price:280, badge:null,         rating:4.4, reviews:65,  description:'Green peas and paneer in a spiced tomato gravy.',                    image:'/images/matar-paneer.jpg' },
  { id:'mc5',  category:'Main Course', name:'Paneer Butter Masala',  price:280, badge:'Bestseller', rating:4.8, reviews:210, description:'Buttery paneer chunks in a silky tomato-cream sauce.',               image:'/images/butter.jpg' },
  { id:'mc6',  category:'Main Course', name:'Paneer Do Pyaza',       price:280, badge:null,         rating:4.4, reviews:54,  description:'Paneer cooked with double the onion for deep flavor.',               image:'/images/do-pyaza.jpg' },
  { id:'mc7',  category:'Main Course', name:'Mushroom Masala',       price:280, badge:null,         rating:4.3, reviews:47,  description:'Fresh mushrooms in a bold spiced masala gravy.',                     image:'/images/mushroom.jpg' },
  { id:'mc8',  category:'Main Course', name:'Mix Veg',               price:220, badge:null,         rating:4.2, reviews:39,  description:'Seasonal vegetables slow-cooked in traditional masala.',             image:'/images/mix-veg.webp' },
  ...
  { id:'ds11', category:'Dessert', name:'Gulab Jamun',            price:80,  badge:'Desi Classic', rating:4.8, reviews:305, description:'Soft milk-solid dumplings soaked in rose-cardamom sugar syrup, served warm.', image:'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400&h=300&fit=crop' },
  ...
  { id:'bv8', category:'Beverages', name:'Masala Chai Latte',      price:80,  badge:'Café Special', rating:4.8, reviews:210, description:'Creamy milk-froth chai with aromatic spices — the ultimate café hug.', image:'https://images.unsplash.com/photo-1544787219-7f47ccb76574?w=400&h=300&fit=crop' },
  ...
  // ── SANDWICH ─────────────────────────────────────────────────
  { id:'sw1', category:'Sandwich', name:'Veg Sandwich',           price:80,  badge:null,        rating:4.2, reviews:88,  description:'Fresh veggies and spread in toasted bread.',              image:'https://images.unsplash.com/photo-1553909489-cd47e0907980?w=400&h=300&fit=crop' },
  { id:'sw2', category:'Sandwich', name:'Veg Cheese Sandwich',    price:120, badge:null,        rating:4.4, reviews:110, description:'Grilled sandwich oozing with melted cheese.',              image:'https://images.unsplash.com/photo-1484723091739-30990106dc29?w=400&h=300&fit=crop' },
  ...
  { id:'sw4', category:'Sandwich', name:'Paneer Tikka Sandwich',  price:120, badge:'Popular',   rating:4.6, reviews:148, description:'Grilled paneer tikka in a toasted herbed sandwich.',      image:'https://images.unsplash.com/photo-1509722747041-616f39b57569?w=400&h=300&fit=crop' },
  { id:'sw5', category:'Sandwich', name:'Cheese Chutney Sandwich',price:150, badge:'Signature', rating:4.7, reviews:165, description:'Green chutney and cheese grilled to golden perfection.', image:'https://images.unsplash.com/photo-1567234669003-dce7a7a88821?w=400&h=300&fit=crop' },
  ...
  // ── ROLL ─────────────────────────────────────────────────────
  { id:'rl1', category:'Roll', name:'Veg Roll',       price:100, badge:null,        rating:4.3, reviews:98,  description:'Crispy veg filling wrapped in a soft paratha roll.',      image:'https://images.unsplash.com/photo-1619221882266-a5f0e18d5ab0?w=400&h=300&fit=crop' },
  { id:'rl2', category:'Roll', name:'Aloo Roll',      price:120, badge:null,        rating:4.3, reviews:80,  description:'Spiced potato filling rolled in a soft layered paratha.', image:'https://images.unsplash.com/photo-1551248429-40975aa4de74?w=400&h=300&fit=crop' },
  ...
  { id:'rl4', category:'Roll', name:'Kathi Roll',     price:160, badge:null,        rating:4.5, reviews:122, description:'Classic Kolkata-style kathi roll with paneer and onions.',image:'https://images.unsplash.com/photo-1565299585323-38d6b0865b47?w=400&h=300&fit=crop' },
  { id:'rl5', category:'Roll', name:'Signature Roll', price:160, badge:'Signature', rating:4.8, reviews:180, description:'Kanha special roll with secret masala and house sauce.',   image:'https://images.unsplash.com/photo-1604908177522-f902573d4b77?w=400&h=300&fit=crop' },
  ...
  { id:'si2',  category:'South Indian', name:'Butter Masala Dosa', price:120, badge:'Bestseller', rating:4.8, reviews:290, description:'Crispy dosa stuffed with spiced potato masala and butter.', image:'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=400&h=300&fit=crop' },
  { id:'si3',  category:'South Indian', name:'Rawa Plain Dosa',    price:110, badge:null,        rating:4.4, reviews:112, description:'Thin crispy semolina dosa — light and lacy.',              image:'https://images.unsplash.com/photo-1645177628172-a94c1f96debb?w=400&h=300&fit=crop' },
  ...
  { id:'si5',  category:'South Indian', name:'Paneer Dosa',        price:160, badge:null,        rating:4.6, reviews:88,  description:'Crispy dosa filled with spiced paneer bhurji.',            image:'https://images.unsplash.com/photo-1589301760014-d929f3979dbc?w=400&h=300&fit=crop' },
  { id:'si6',  category:'South Indian', name:'Pizza Dosa',         price:220, badge:'Fusion',    rating:4.7, reviews:142, description:'Crispy dosa topped with pizza sauce and mozzarella.',      image:'https://images.unsplash.com/photo-1574071318508-1cdbab80d002?w=400&h=300&fit=crop' },
  { id:'si7',  category:'South Indian', name:'Veg Uttapam',        price:150, badge:null,        rating:4.4, reviews:75,  description:'Thick rice pancake topped with fresh vegetables.',         image:'https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?w=400&h=300&fit=crop' },
  { id:'si8',  category:'South Indian', name:'Tomato Uttapam',     price:150, badge:null,        rating:4.4, reviews:68,  description:'Uttapam topped with tomato, onion and green chilli.',      image:'https://images.unsplash.com/photo-1567188040759-fb8a883dc6d8?w=400&h=300&fit=crop' },
  { id:'si9',  category:'South Indian', name:'Idli Sambar',        price:90,  badge:'Light',     rating:4.5, reviews:210, description:'Steamed soft idli with piping hot sambar and chutneys.',   image:'https://images.unsplash.com/photo-1606491956391-6a10fc07ce96?w=400&h=300&fit=crop' },
  { id:'si10', category:'South Indian', name:'Vada Sambar',        price:90,  badge:null,        rating:4.4, reviews:145, description:'Crispy medu vada with sambar and coconut chutney.',        image:'https://images.unsplash.com/photo-1606491956391-6a10fc07ce96?w=400&h=300&fit=crop' },
  { id:'si11', category:'South Indian', name:'Veg Chilla',         price:150, badge:null,        rating:4.3, reviews:60,  description:'Savoury besan chilla with veggies and green chutney.',     image:'https://images.unsplash.com/photo-1645177628172-a94c1f96debb?w=400&h=300&fit=crop' },
  { id:'si12', category:'South Indian', name:'Paneer Chilla',      price:180, badge:'Rich',      rating:4.6, reviews:88,  description:'Besan chilla stuffed with spiced paneer bhurji.',          image:'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=400&h=300&fit=crop' },
  ...
  { id:'ch19', category:'Chinese', name:'Veg Biryani (Chinese)',   price:220, badge:'Spicy',     rating:4.5, reviews:118, description:'Indo-Chinese style biryani with wok-tossed vegetables and bold sauces.', image:'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400&h=300&fit=crop' },
  ...
  { id:'fr3', category:'Fries', name:'Loaded Cheese Fries', price:180, badge:'Cheesy 🧀', rating:4.8, reviews:198, description:'Crispy fries smothered in molten cheese sauce with jalapeños and herbs.', image:'https://images.unsplash.com/photo-1630384060421-cb20d0e0649d?w=400&h=300&fit=crop' },
  ...
  { id:'pr2', category:'Paratha', name:'Paneer Paratha',            price:160, badge:'Favourite',   rating:4.8, reviews:248, description:'Flaky paratha stuffed with fresh crumbled paneer and herbs.',  image:'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=400&h=300&fit=crop' },
  { id:'pr3', category:'Paratha', name:'Aloo Paneer Paratha',       price:160, badge:null,          rating:4.7, reviews:180, description:'Best of both worlds — aloo and paneer in one paratha.',       image:'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400&h=300&fit=crop' },
  { id:'pr4', category:'Paratha', name:'Soya Chaap Laccha Paratha', price:230, badge:'Signature ⭐', rating:4.9, reviews:165, description:'Soya chaap gravy served with flaky laccha paratha.',           image:'https://images.unsplash.com/photo-1599487488170-d11ec9c172f0?w=400&h=300&fit=crop' },

  // ── CHOLE (Kulche + Bhature) ─────────────────────────────────
  { id:'ck1', category:'Chole', name:'Chole Kulche',    price:120, badge:'Classic',  rating:4.7, reviews:195, description:'Spiced chole served with soft baked kulche bread.',      image:'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=400&h=300&fit=crop' },
  { id:'ck2', category:'Chole', name:'Extra Chole',     price:70,  badge:null,       rating:4.2, reviews:28,  description:'Extra portion of spiced chole masala.',                 image:'https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400&h=300&fit=crop' },
  ...
  { id:'ck4', category:'Chole', name:'Chole Bhature',   price:140, badge:'Punjabi',  rating:4.8, reviews:265, description:'Fluffy deep-fried bhatura with tangy spiced chole.',    image:'https://images.unsplash.com/photo-1606491956689-2ea866880c84?w=400&h=300&fit=crop' },
